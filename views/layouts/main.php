	...
	<body>
		<section id="container">
			<header class="header black-bg">
				...
				<!--logo start-->
				<a href="<?=Yii::$app->getUrlManager()->createUrl(['/'])?>" class="logo"><b>大学区域管理系统</b></a>
				<!--logo end-->
			...
			<aside>
				<div id="sidebar" class="nav-collapse ">
					...
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<h5 class="centered"><?=College::instance()->getCurrentLoginCollege('name')?> - <?=CollegeDormArea::instance()->getCurrentLoginCollegeDormArea('name')?></h5>
			...
			<footer class="site-footer">
				<div class="text-center">
					<?=date('Y')?> - <?=Yii::$app->name?>@xiawei <a href="javascript:void(0)" class="go-top"> <i class="fa fa-angle-up"></i></a>
				</div>
			</footer>
			<!--footer end-->
		</section>
